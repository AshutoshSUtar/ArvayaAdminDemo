...
;
import { HTTPintercptorInterceptor } from './Service/httpintercptor.interceptor';
import { AuthGuard } from './Service/auth.guard';
import { MasterModule } from './Pages/Master Module/masters.module';
...
@NgModule({
  ...
  providers: [{ provide: NZ_I18N, useValue: en_US }, NzNotificationService,  {provide : HTTP_INTERCEPTORS, useClass: HTTPintercptorInterceptor , multi:true},AuthGuard],
